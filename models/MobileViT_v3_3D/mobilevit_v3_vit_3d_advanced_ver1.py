...
class Mobilevit(nn.Module):
    def __init__(self, image_size, dims, channels, num_classes, expansion=4, kernel_size=3, patch_size=(2, 2, 2), device=torch.device("cuda:5")):
        ...
        self.vit = SimpleViT(dims[2], L[2], 128, [(2, 6, 2), (2, 2, 6), (20, 2, 2)], heads=4, dim_head=32).to(device)
        ...
        self.deconv1 = nn.ConvTranspose3d(384, channels[10], kernel_size=(3, 3, 3), stride=(1, 3, 3), padding=(1, 2, 2)).to(device)  # 640 + 320
