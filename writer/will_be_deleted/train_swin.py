...
import numpy as np
import models.SwinTransformer_3D.config as config
import wandb
...
if __name__ == '__main__':
    ...
    network = models.SwinTransformer_3D.swin_transformer_v2.SwinTransformerV2(**params).to(torch.device("cuda:5"))
