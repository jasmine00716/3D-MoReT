...
class Mobilevit(nn.Module):
    ...
    def forward(self, x):  # (1, 40, 20, 224, 224)
        ...
        mvit_2 = self.mvit[2](mv2_7)  # (1, 320, 20, 6, 6)
        # print("mvit2", mvit_2.shape)

        conv2 = self.conv2(mvit_2)  # (1, 640, 20, 6, 6)
        # print("conv2", conv2.shape)

        deconv1 = self.deconv1(conv2)  # (1, 320, 20, 14, 14)
...
if __name__ == '__main__':
    ...
    network_architecture = {
        "parameters": {
            ...
            "dims": [64, 80, 96],
            "channels": [52, 52, 52, 64, 64, 64, 128, 128, 256, 256, 512, 512, 1024],  # [16, 16, 24, 24, 48, 48, 64, 64, 80, 80],  # [16, 64, 128, 256, 512],  # [16, 24, 48, 64, 80, 320]
            "kernel_size": 3,
            "patch_size": (2, 2, 2),
            "num_classes": 7,
            "expansion": 2,
